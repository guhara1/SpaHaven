// 구별 법정동 전체 안내 데이터 (서울 25개 구)
// 원칙:
//  - 각 구의 법정동을 빠짐없이 수록 (역삼1동·역삼2동 등 번호 행정동은 대표 법정동 1개로 통합)
//  - 개별 동 페이지는 만들지 않음(도어웨이 방지) — 관련 생활권·역세권 페이지가 있을 때만 링크(l)로 연결
//  - 링크가 없는 동은 텍스트 표기만, 방문 상담은 모든 동 가능
module.exports = {
  'gangnam-gu': [
  ...
  'gangseo-gu': [
    ...
    { n: '내발산동', l: 'seoul/life/magok-balsan/' },
    { n: '외발산동' }, { n: '화곡동' }, { n: '등촌동' }, { n: '가양동' },
    { n: '염창동' }, { n: '공항동' }, { n: '방화동' }, { n: '개화동' },
    { n: '과해동' }, { n: '오곡동' }, { n: '오쇠동' },
  ],
  'mapo-gu': [
    { n: '서교동', l: 'seoul/life/hongdae-hapjeong/' },
    { n: '합정동', l: 'seoul/life/hongdae-hapjeong/' },
    { n: '동교동' }, { n: '연남동' }, { n: '망원동' }, { n: '성산동' },
    { n: '상암동' }, { n: '중동' },
    { n: '공덕동', l: 'seoul/life/gongdeok-mapo/' },
    { n: '신공덕동' }, { n: '아현동' }, { n: '도화동' }, { n: '용강동' },
    { n: '토정동' }, { n: '마포동' }, { n: '대흥동' }, { n: '염리동' },
    { n: '노고산동' }, { n: '신수동' }, { n: '현석동' }, { n: '구수동' },
    { n: '창전동' }, { n: '상수동' }, { n: '하중동' }, { n: '당인동' },
  ],
  'seodaemun-gu': [
    { n: '신촌동' }, { n: '창천동' }, { n: '연희동' }, { n: '홍제동' },
    { n: '홍은동' }, { n: '남가좌동' }, { n: '북가좌동' }, { n: '대현동' },
    { n: '대신동' }, { n: '봉원동' }, { n: '북아현동' }, { n: '충정로' },
    { n: '합동' }, { n: '미근동' }, { n: '냉천동' }, { n: '천연동' },
    { n: '옥천동' }, { n: '영천동' }, { n: '현저동' },
  ],
  'eunpyeong-gu': [
    { n: '대조동', l: 'seoul/life/yeonsinnae-eunpyeong/' },
    { n: '불광동', l: 'seoul/life/yeonsinnae-eunpyeong/' },
    { n: '응암동' }, { n: '녹번동' }, { n: '갈현동' }, { n: '구산동' },
    { n: '역촌동' }, { n: '신사동' }, { n: '증산동' }, { n: '수색동' }, { n: '진관동' },
  ],
  'seongdong-gu': [
    { n: '성수동', l: 'seoul/life/seongsu-wangsimni/' },
    { n: '행당동', l: 'seoul/life/seongsu-wangsimni/' },
    { n: '왕십리동' }, { n: '도선동' }, { n: '마장동' }, { n: '사근동' },
    { n: '응봉동' }, { n: '금호동' }, { n: '옥수동' }, { n: '송정동' },
    { n: '용답동' }, { n: '하왕십리동' }, { n: '상왕십리동' },
  ],
  'gwangjin-gu': [
  ...
  'gangbuk-gu': [
    { n: '수유동' }, { n: '미아동' }, { n: '번동' }, { n: '우이동' },
  ],
  'seongbuk-gu': [
    { n: '성북동' }, { n: '삼선동' }, { n: '동선동' }, { n: '돈암동' },
    { n: '안암동' }, { n: '보문동' }, { n: '정릉동' }, { n: '길음동' },
    { n: '종암동' }, { n: '하월곡동' }, { n: '상월곡동' }, { n: '장위동' }, { n: '석관동' },
  ],
  'jongno-gu': [
    { n: '세종로', l: 'seoul/life/jongno-gwanghwamun/' },
    { n: '종로1·2·3·4가', l: 'seoul/life/jongno-gwanghwamun/' },
    { n: '종로5·6가' }, { n: '사직동' }, { n: '삼청동' }, { n: '가회동' },
    { n: '혜화동' }, { n: '명륜동' }, { n: '이화동' }, { n: '창신동' },
    { n: '숭인동' }, { n: '청운효자동' }, { n: '부암동' }, { n: '평창동' },
    { n: '무악동' }, { n: '교남동' },
  ],
  'jung-gu': [
    { n: '명동', l: 'seoul/life/myeongdong-euljiro/' },
    { n: '을지로동', l: 'seoul/life/myeongdong-euljiro/' },
    { n: '소공동' }, { n: '회현동' }, { n: '필동' }, { n: '충무로' },
    { n: '장충동' }, { n: '광희동' }, { n: '신당동' }, { n: '황학동' },
    { n: '다산동' }, { n: '약수동' }, { n: '청구동' }, { n: '중림동' },
    { n: '순화동' }, { n: '의주로' },
  ],
  'yongsan-gu': [
    ...
    { n: '남영동', l: 'seoul/life/yongsan-seoul-station/' },
    { n: '이촌동' }, { n: '서빙고동' }, { n: '보광동' }, { n: '청파동' },
    { n: '원효로동' }, { n: '효창동' }, { n: '용문동' }, { n: '한강로동' }, { n: '후암동' },
  ],
};
